...
async function getCreditsUsage(): Promise<CreditsUsageData | null> {
  try {
    const res = await fetchWithToken("/users/credits-usage");
...
export default async function CreditsUsagePage() {
  const data = await getCreditsUsage();
      ...
      >
        ...
        <div className="px-6 py-5">
          ...
          <div className="flex items-center justify-between mb-2.5">
            ...
            <p className="text-xs font-semibold" style={{ color: clampedPct >= 90 ? "#ef4444" : clampedPct >= 70 ? "#f59e0b" : "rgba(255,255,255,0.7)" }}>
              {clampedPct}%
            </p>
          </div>
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span
                      ...
                      style={{ color: item.usage > 0 ? "rgba(255,255,255,0.85)" : "rgba(255,255,255,0.25)" }}
                    >
