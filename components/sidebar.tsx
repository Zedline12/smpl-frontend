    ...
    <aside className="w-64 bg-white border-r border-gray-100 flex flex-col h-screen fixed left-0 top-0 z-30">
      <div className="p-6">
        ...
        <nav className="space-y-1">
          <Link
            href="/workspace"
            className="flex items-center gap-3 px-3 py-2 text-gray-700 rounded-lg bg-gray-50 font-medium transition-colors"
          >
            <svg
              className="w-5 h-5"
              fill="none"
          ...
          <Link
            ...
            className="flex items-center gap-3 px-3 py-2 text-gray-500 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-colors font-medium"
          >
            <svg
              className="w-5 h-5"
              fill="none"
