...
import {
  ISeedance25Input,
  Seedance25InputConst,
} from "@/features/generation/types/models/seedance-2.5.type";
import { AiModelsEnum } from "@/features/generation/enums/models.enum";

export default function Seedance25Composer({
  isFocused,
  editMode,
}: {
  isFocused: boolean;
  ...
  const state = states[AiModelsEnum.SEEDANCE_2_5] as ISeedance25Input;
  const setField = (key: string, value: any) =>
    setModelField(AiModelsEnum.SEEDANCE_2_5, key, value);
        ...
        <div className="grid grid-cols-2 sm:flex sm:flex-row w-full gap-2 sm:gap-0">
          ...
          >
            <MenuItem className="p-0 m-0 sm:w-100 w-[200px]">
              <AspectRatioSelectorComponent
                options={Seedance25InputConst.aspectRatio as any}
          ...
          >
            <MenuItem className="p-0 m-0 sm:w-100 w-[max-content]">
              <DurationSelector
                options={Seedance25InputConst.duration}
                value={duration!}
          ...
          >
            <MenuItem className="p-0 m-0 sm:w-100 w-[max-content]">
              <ResolutionSelector
                options={Seedance25InputConst.resolution as any}
