...
import {
  KlingO3ImageOptionsConst,
  KlingO3ImageInput,
} from "@/features/generation/types/models/kling-o3-image.type";
...
export default function KlingO3ImageComposer({
  ...
  const state = states[AiModelsEnum.KLING_O3_IMAGE] as KlingO3ImageInput;
  const setField = (key: string, value: any) =>
    setModelField(AiModelsEnum.KLING_O3_IMAGE, key, value);
